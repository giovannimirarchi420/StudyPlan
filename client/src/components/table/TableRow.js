    ...
    return (
        <>
            <tr key={props.course.id} id={props.course.id} className={checked ? "selected-row" : ""}>
                ...
                <td key={props.course.id + "-td5"}
                    id={props.course.id + "-td5"}>{props.course.max_students ? props.course.max_students : "-"}</td>
                <td key={props.course.id + "-td6"} id={props.course.id + "-td6"}
                    onClick={() => handleClick(props.course.id)}>
                    <Arrow/>
                </td>
                {props.checkbox ?
                    props.selectable ?
                        <td><input onChange={handleCheckbox} id={props.course.id + "-checkbox-select"}
                                   type={"checkbox"}/></td> :
                        <td><NoSelectableIcon isShowing={!props.selectable} course={props.course}
                                              selectedCourse={props.selectedCourse}/></td> : ""}
            </tr>
